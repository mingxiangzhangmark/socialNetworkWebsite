...
import { Button, Card, Grid, Header, TabPane , Image} from "semantic-ui-react"
           ...
           <Grid>
               <Grid.Column width={16}>
                   <Header floated='left' icon='photo' content='Photos'/>
                     {isCurrentUser &&
                   <Button floated="right" basic content= {editMode ? 'Cancel':'Add Photo'} onClick={()=>setEditMode(!editMode)}/>
                     }
               </Grid.Column>
               <Grid.Column width={16}>
